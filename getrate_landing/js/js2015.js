...
$(document).ready(function () {
    ...
    var input = {
        ...
        valEmail: function valEmail() {
            ...
            $(this).on('keyup', function () {
                regExp.test($(_this2).val()) ? $(_this2).removeClass('invalid') : $(_this2).addClass('invalid');
            });
        }
    };

    $('#InputPhone').mask('+380 (99) 999 99 99', input);
    ...
    $('#form').on('submit', function (e) {
        ...
        if (formValid) {
            ...
            $.post("https://httpbin.org/post", userData, onAjaxSuccess);
